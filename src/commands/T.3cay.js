...
//       global.moduleData.baicao.set(event.threadID, {
//         author: senderID,
//         start: 0,
//         chiabai: 0,
//         ready: 0,
//         player: [{ id: senderID, card1: 0, card2: 0, card3: 0, doibai: 2, ready: false }],
//         rateBet: Number(args[1]),
//       });
...
//       } else {
//         values.player.splice(
//           values.player.findIndex((item) => item.id === senderID),
//           1
//         );
...
//         return api.sendMessage('Hiện tại bàn của bạn không có người chơi nào tham gia, bạn có thể mời người đấy tham gia bằng cách yêu cầu người chơi khác nhập 3cay join', threadID, messageID);
...
//     case '-i': {
//       if (typeof values.player == 'undefined') return api.sendMessage('Hiện tại chưa có bàn 3 cây nào, bạn có thể tạo bằng cách sử dụng 3cay create', threadID, messageID);
//       return api.sendMessage('=== 3 cây ===' + '\n- Author Bàn: ' + values.author + '\n- Tổng số người chơi: ' + values.player.length + ' Người', threadID, messageID);
//     }
